...
On the **Contacts** screen in the application, next to each contact, there is an option labeled "Ignore" 
...
**Is the contact deleted from the system?** No. They are only hidden from the main list. **Can a contact be restored at any stage?** Yes. You can unignore at any time.
...
במסך **אנשי הקשר** באפליקציה, לצד כל איש קשר קיימת אפשרות בשם “התעלם”- 
...
לא. הוא רק מוסתר מהרשימה הראשית.

**האם ניתן להחזיר איש קשר בכל שלב?**  
כן. ניתן לבטל את ההתעלמות בכל עת.
